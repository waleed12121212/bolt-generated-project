        ...
        public class ProductApplicationService : Bazingo_Application.Interfaces.IProductService
        {
            ...
            public async Task<ApiResponse<ProductDto>> GetProductByIdAsync(int id)
            {
                try
                {
                    ...
                    return ApiResponse<ProductDto>.CreateSuccess(productDto);
                }
                catch (Exception ex)
                {
            ...
            public async Task<ApiResponse<ProductDto>> CreateProductAsync(CreateProductDto dto, string sellerId)
            {
                try
                {
                    if (dto == null)
                    {
                        return ApiResponse<ProductDto>.CreateError("CreateProductDto object is required.");
                    }
                    ...
                    return ApiResponse<ProductDto>.CreateSuccess(MapToDto(createdProduct));
                }
                catch (Exception ex)
                {
            ...
            public async Task<ApiResponse<ProductDto>> UpdateProductAsync(int id, UpdateProductDto dto)
            {
                try
                {
                    if (dto == null)
                    {
                        return ApiResponse<ProductDto>.CreateError("UpdateProductDto object is required.");
                    }
                    ...
                    return ApiResponse<ProductDto>.CreateSuccess(MapToDto(updatedProduct));
                }
                catch (Exception ex)
                {
