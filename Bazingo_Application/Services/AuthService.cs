    ...
    public class AuthService : IAuthService
    {
        ...
        public async Task<ApiResponse<string>> ExternalLoginAsync(IExternalAuthModel model)
        {
            try
            {
                ...
                if (info == null)
                {
                    return ApiResponse<string>.CreateError("External login information not found");
                }
        ...
        public async Task<ApiResponse<string>> RefreshTokenAsync(string token)
        {
            try
            {
                ...
                return ApiResponse<string>.CreateSuccess(newToken);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ApiResponse<bool>> RevokeTokenAsync(string token)
        {
            try
            {
                ...
                if (user == null)
                {
                    return ApiResponse<bool>.CreateError("Invalid token");
                }

                // Add your token revocation logic here
                return ApiResponse<bool>.CreateSuccess(true);
            }
            catch (Exception ex)
            {
